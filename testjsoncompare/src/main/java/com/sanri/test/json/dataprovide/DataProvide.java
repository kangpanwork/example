package com.sanri.test.json.dataprovide;

import com.sanri.test.json.dataprovide.RandomUtil;
...
public class DataProvide {
    ...
    public Car car(){
        return (Car) populateDataComplex(Car.class);
    }

    public List<Car> cars(int length){
    ...
    public ComplexDto complexDto(){
        return (ComplexDto) populateDataComplex(ComplexDto.class);
    }
    ...
    public Parking parking(){
        ...
        parking.setName("某某停车场");
        parking.addDevice(new Camera(RandomUtil.uuid(),"东部摄像头全景"));
        parking.addDevice(new Camera(RandomUtil.uuid(),RandomUtil.username()));
        parking.addDevice(new DoorAccess(RandomUtil.uuid(),RandomUtil.username(),RandomUtil.address()));
